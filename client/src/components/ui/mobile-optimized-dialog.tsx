  ...
  <MobileDialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "sm:data-[state=open]:slide-in-from-top-[48%] data-[state=open]:slide-in-from-bottom-full",
        "sm:data-[state=closed]:slide-out-to-top-[48%] data-[state=closed]:slide-out-to-bottom-full",
        className
      )}
      {...props}
    >
