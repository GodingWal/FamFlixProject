...
const Navbar = () => {
  ...
  if (isMobile) {
    return (
              <div className="fixed bottom-0 left-0 right-0 z-50 bg-background border-t border-border/50 safe-area-pb shadow-2xl">
        <div className="flex justify-around items-center py-2">
          ...
          <Sheet>
            ...
            <SheetContent side="bottom" className="h-[85vh] rounded-t-3xl border-0 shadow-2xl bg-background">
  ...
  return (
    <>
              <div className="fixed top-0 left-0 right-0 bg-background border-b border-border/50 z-50 shadow-sm">
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-4">
            <Sheet>
              ...
              <SheetContent side="left" className="w-80 border-r-0 shadow-2xl bg-background overflow-y-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 bg-background border-border/50 shadow-xl">
